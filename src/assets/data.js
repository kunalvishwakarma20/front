...
const FOOTER_CONTACT_INFO = {
  ...
  links: [
    ...
    { label: "Email Address", value: "YuvrajVarVadhu.com" },
  ],
};
...
export const SOCIALS = {
  title: "Social",
  links: [
    { name: "Facebook", url: "https://www.facebook.com/yourprofile", icon: facebook },
    { name: "Instagram", url: "https://www.instagram.com/yourprofile", icon: instagram },
    { name: "Twitter", url: "https://www.twitter.com/yourprofile", icon: twitter },
    { name: "YouTube", url: "https://www.youtube.com/yourchannel", icon: youtube },
    { name: "LinkedIn", url: "https://www.linkedin.com/in/yourprofile", icon: linkedin }
  ]
};
